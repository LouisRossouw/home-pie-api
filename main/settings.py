...
INSIGHTS_API_URL = os.getenv('INSIGHTS_API_URL', "http://10.0.0.152:5006")
PING_PING_API_URL = os.getenv('PING_PING_API_URL', "http://10.0.0.152:5005")
...
SPECTACULAR_SETTINGS = {
    ...
    'CAMELIZE_NAMES': True,  # Changes urls from snake case to camel case.
    'POSTPROCESSING_HOOKS': [
        # Changes snake case to camel case in the return response
...
print("data_path >>> :", os.getenv('DATA_DIR'))
